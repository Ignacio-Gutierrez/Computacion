...
class CoffeeMachineTest(unittest.TestCase):
    ...
    def test_initial_not_coin(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'Inserte una moneda')
    ...
    def test_not_water(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'No hay agua')  
    ...
    def test_not_coffee(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'No hay café')  
    ...
    def test_not_sugar(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'No hay azucar')  
    ...
    def test_not_milk(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'No hay leche')  
    ...
    def test_not_chocolate(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'No hay chocolate')  
    ...
    def test_not_tea(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'No hay té')  
    ...
    def test_get_cafe_alone(self):
        ...
        self.assertEqual(machine.CafeteraPlus(), 'Haciendo Café Simple')
    ...
    def test_get_cafe_double(self):
        machine = MasterCoffeeMachine()
        machine.add_resource('coin', 1)
        machine.chose_drink(2)
        self.assertEqual(machine.CafeteraPlus(), 'Haciendo Café Doble')
        self.assertEqual(machine.resources['water'], 6500-200)
    ...
    def test_get_coffee_milk_ok(self):
        ...
        machine.chose_drink(3)
        self.assertEqual(machine.CafeteraPlus(), 'Haciendo Café con Leche')
    ...
    def test_get_coffee_milk_double_ok(self):
        machine = MasterCoffeeMachine()
        machine.add_resource('coin', 1)
        machine.chose_drink(4)
        self.assertEqual(machine.CafeteraPlus(), 'Haciendo Café Doble con Leche')
    ...
    def test_get_capuccino_ok(self):
        machine = MasterCoffeeMachine()
        machine.add_resource('coin', 1)
        machine.chose_drink(5)
        self.assertEqual(machine.CafeteraPlus(), 'Haciendo Capuchino')
    ...
    def test_get_tea_simple_ok(self):
        machine = MasterCoffeeMachine()
        machine.add_resource('coin', 1)
        machine.chose_drink(6)
        self.assertEqual(machine.CafeteraPlus(), 'Haciendo Té')
        self.assertEqual(machine.resources['water'], 6500-200)
